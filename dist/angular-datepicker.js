        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            function showPicker() {
                ...
                if (position === 'absolute') {
                    ...
                    var top = element[0].offsetHeight - scrollOffset;

                    //now check if the datepicker is going below the page limit
                    ...
                    var pickerLowerBound = element[0].getBoundingClientRect().top + picker[0].offsetHeight;

                    if (pickerLowerBound > docHeight && isFixedPosition) {
                        //the picker is going to overflow the bottom of the page, so we show it above th field instead of below
                        top -= (picker[0].offsetHeight + element[0].offsetHeight);
                    }
                    //!!!!!!!!!!!!!!!!!!!!!!!!!! END CALDERA CHANGES !!!!!!!!!!!!!!!!!!!!!!!!!
                    picker.css({
                        top: top + 'px',
...
$templateCache.put('templates/datepicker.html',
    ...
    "                <tr>\n" +
    "                    <td colspan=\"7\">\n" +
    "                        <span ng-repeat=\"minute in minutes\" ng-class=\"classes[$index]\" ng-click=\"selectDate(minute)\" ng-bind=\"minute|mFormat:internationalHour:tz\"></span>\n" +
    "                    </td>\n" +
    "                </tr>\n" +
    "            </tbody>\n" +
    "        </table>\n" +
